...
public class CheckKintai extends HttpServlet {
	public String hour, minute, name;
   /* public ArrayList<LinkData> orderList = new ArrayList<LinkData>();
    ...
    protected void doPost(HttpServletRequest request,
		...
		/*for (int i = 0; i < product.length; i++) {
			...
			LinkData data = new LinkData(name, hour + ":" + minute, date);
			...
			response.sendRedirect("/ShowRegister.html");
		}
